...
if (-not $args -contains "-nobuild")
{
  ...
  dotnet build .\src\TypeGen\TypeGen.Core -f net7.0 -c Release
}
...
dotnet publish .\src\TypeGen\TypeGen.Cli -c Release -f net7.0
...
#net7.0
new-item -Force -Path nuget\lib\net7.0 -ItemType Directory
$binFolder = if (test-path "src\TypeGen\TypeGen.Core\bin\Any CPU\Release\net7.0") {"bin\Any CPU"} else {"bin"}
copy "src\TypeGen\TypeGen.Core\$($binFolder)\Release\net7.0\TypeGen.Core.dll" nuget\lib\net7.0
copy "src\TypeGen\TypeGen.Core\$($binFolder)\Release\net7.0\TypeGen.Core.xml" nuget\lib\net7.0
...
new-item -Force -Path nuget-dotnetcli\tools\net7.0\any -ItemType Directory
$binFolder = if (test-path "src\TypeGen\TypeGen.Cli\bin\Any CPU\Release\net7.0\publish") {"bin\Any CPU"} else {"bin"}
copy -Recurse "src\TypeGen\TypeGen.Cli\$($binFolder)\Release\net7.0\publish\*" nuget-dotnetcli\tools\net7.0\any

New-Item nuget-dotnetcli\tools\net7.0\any\DotnetToolSettings.xml
set-content nuget-dotnetcli\tools\net7.0\any\DotnetToolSettings.xml '<?xml version="1.0" encoding="utf-8"?>
