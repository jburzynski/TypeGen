...
if (-not $args -contains "-nobuild")
{
  ...
  dotnet build .\src\TypeGen\TypeGen.Core -f net6.0 -c Release
}
...
dotnet publish .\src\TypeGen\TypeGen.Cli -c Release -f net6.0
...
$binFolder = if (test-path "src\TypeGen\TypeGen.Core\bin\Any CPU\Release\net6.0") {"bin\Any CPU"} else {"bin"}
copy "src\TypeGen\TypeGen.Core\$($binFolder)\Release\net6.0\TypeGen.Core.dll" nuget\lib\net6.0
copy "src\TypeGen\TypeGen.Core\$($binFolder)\Release\net6.0\TypeGen.Core.xml" nuget\lib\net6.0
