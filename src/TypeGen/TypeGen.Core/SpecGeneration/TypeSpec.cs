...
internal class TypeSpec
{
    ...
    private readonly List<AdditionalClassProperty> _additionalClassProperties = new List<AdditionalClassProperty>();
    ...
    public IEnumerable<AdditionalClassProperty> AdditionalClassProperties => _additionalClassProperties;
    ...
    public void AddAdditionalClassProperty(string name, string type, string? defaultValue)
    {
        _additionalClassProperties.Add(new AdditionalClassProperty
        {
            Name = name,
            Type = type,
