...
namespace TypeGen.IntegrationTest.Blacklist
{
    public class BlacklistTest : GenerationTestBase
    {
        ...
        public async Task ClassWithBlacklistedBase_Test()
        {
            ...
            const string expectedLocation = "TypeGen.IntegrationTest.Blacklist.Expected.class-with-blacklisted-base.ts";
        ...
        public async Task ClassWithBlacklistedInterface_Test()
        {
            ...
            const string expectedLocation = "TypeGen.IntegrationTest.Blacklist.Expected.class-with-blacklisted-interface.ts";
        ...
        public async Task InterfaceWithBlacklistedBase_Test()
        {
            ...
            const string expectedLocation = "TypeGen.IntegrationTest.Blacklist.Expected.interface-with-blacklisted-base.ts";
            var blacklist = new HashSet<string> { typeof(IFoo).FullName };
